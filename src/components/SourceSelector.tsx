...
export const SourceSelector = ({ sourceType, setSourceType }: SourceSelectorProps) => {
  ...
  const options = [
    { value: 'PDF', label: t('source.pdf'), icon: FileText, description: t('source.pdfDesc') },
    { value: 'Website', label: t('source.website'), icon: Globe, description: t('source.websiteDesc') },
    { value: 'Both', label: t('source.both'), icon: Layers, description: t('source.bothDesc') },
  ];
